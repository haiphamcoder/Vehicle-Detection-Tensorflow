...
def predict_speed(top, bottom, right, left, current_frame_number, crop_img, roi_position, ):
    ...
    is_in_roi = True  # is the object that is inside Region Of Interest
    update_csv = False
    ...
    if len(bottom_position_of_detected_vehicle) != 0 and bottom - bottom_position_of_detected_vehicle[0] > 0 and 195 < \
            bottom_position_of_detected_vehicle[0] < 240 and roi_position < bottom + 100 and (
            current_frame_number - current_frame_number_list_2[0]) > 24:
    ...
    if is_in_roi:
        ...
        # chenge 44 to get length in meters for your case)
